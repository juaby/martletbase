...
mod tests {
    ...
    use crate::discovery::{Cluster, DataSegment, DisAlgorithm, DisRules, DisTable, DisType, MetaSegment, Segment, Segments};
    ...
    fn test_yaml_from_file() {
        let mut file = File::open("./etc/martlet.yaml").expect("Unable to open file");
